...
| `sensor.<device_name>_next_service`                         | Sensor showing how many days left until next service                                                                                                         | :no_entry_sign: |
...
| `sensor.<device_name>_regeneration_remaining_time`          | Sensor showing the remaining amount / time of current regeneration step”                                                                                     | :no_entry_sign: |
